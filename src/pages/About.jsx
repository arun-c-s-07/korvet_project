...
function About() {
  const timelineItems = [
    {
      date: '🚀 January 2025',
      title: 'Korvet Was Born',
      desc: 'A spark ignited by tech & open-source enthusiasts. Korvet was born with a bold vision.',
    },
    {
      date: '📍 March 2025',
      title: 'First Client Project',
      desc: 'Delivered our first external client project with minimal resources and maximum effort.',
    },
    {
      date: '💡 April 2025',
      title: 'Idea to Impact',
      desc: 'Created innovative tools internally while onboarding talented interns and building team culture.',
    },
    {
      date: '🌱 May 2025',
      title: 'AetherVest Initiated',
      desc: 'Laid the foundation of AetherVest — our flagship travel-tech platform.',
    },
    {
      date: '🏛️ June 2025',
      title: 'Company Registered',
      desc: 'Korvet Innovations became an official entity under LLP, MSME & IIC, with GitHub affiliation.',
    },
    {
      date: '🚀 Now',
      title: 'Building Futures with Tech',
      desc: 'Crafting dynamic products, partnering with institutions, and building a community-first tech brand.',
    }
  ];
  ...
  return (
    <div className="about-page">
      ...
      >
        ...
        <p>Where curious minds build powerful realities. 🚀</p>
      </motion.section>
      ...
      >
        <blockquote>
          "We don’t build apps — we architect revolutions."
        </blockquote>
