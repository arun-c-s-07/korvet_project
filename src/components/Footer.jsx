    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-brand">
          ...
          <p>🛠️ Building smart, scalable, and <strong>sustainable</strong> tech for tomorrow.</p>
        </div>
        ...
        <div className="footer-links">
          ...
          <a href="/careers"><FaAngleRight /> Careers</a>
      ...
      <div className="footer-bottom">
        <p>&copy; {new Date().getFullYear()} Korvet Innovations. Crafted with ❤️ by the Korvet Team.</p>
      </div>
    </footer>
  );
}
